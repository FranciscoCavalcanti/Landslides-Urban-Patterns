...
* `database_panel.rds`: Annual panel data of Brazilian municipalities.
* `restricted_PSM_database.rds`: Municipalities selected through the propensity score matching method.
* `population_census_database.rds`: Decadal panel data of Brazilian municipalities.
