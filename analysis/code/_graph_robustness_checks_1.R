...
output_path <- paste0(path_output_git, "_graph_robustness_checks_urban_size_base_period_universal.jpg")
ggsave(output_path, output[[1]], width = 20, height = 10, units = "in", dpi = 300)

output_path <- paste0(path_output_git, "_graph_robustness_checks_sprawl_index_base_period_universal.jpg")
ggsave(output_path, output[[2]], width = 20, height = 10, units = "in", dpi = 300)
