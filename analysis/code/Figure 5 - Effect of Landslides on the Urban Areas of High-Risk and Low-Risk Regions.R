...
# Generate plots for 'lurban_size'  using the defined function
names <- c('lurban_size_high_risk_max_30','lurban_size_low_risk_max_30')
...
# Loop to save each plot in the output directory with the appropriate filename
